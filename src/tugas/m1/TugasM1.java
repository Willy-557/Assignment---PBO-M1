                ...
                while (true) {
                    ...
                    if (menu1.equals("0")) {
                        ...
                        while (true) {
                            ...
                            System.out.print(">> ");
                            String menuBeliMesin = scanner.nextLine();

                            if (menuBeliMesin.equals("0")) {
                                System.out.println("Akan dikembalikan ke halaman Kelola Mesin");
                                break;
                            }
                            else if (menuBeliMesin.equals("1")) {
                                if (gold >= 50) {
                            ...
                            else if (menuBeliMesin.equals("2")) {
                                if (gold >= 30) {
                                    System.out.print("Pilih slot kosong (0-5): ");
                            ...
                            else if (menuBeliMesin.equals("3")) {
                                if (gold >= 80) {
                                    System.out.print("Pilih slot kosong (0-5): ");
